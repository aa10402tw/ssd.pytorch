...
class mySSD(nn.Module):
    def __init__(self, phase, size, base, extras, head, num_classes):
        ...
        # add more boxes !
        self.loc = nn.ModuleList([nn.Conv2d(256, 16, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))] + head[0])
        self.conf = nn.ModuleList([nn.Conv2d(256, 84, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))] + head[1])
        # print(self.loc)
        # print(self.conf)
...
def build_ssd300_fpn75(phase, size=300, num_classes=21):
    if phase != "test" and phase != "train":
        print("ERROR: Phase: " + phase + " not recognized")
        return
    if size != 300:
...
if __name__ == '__main__':
    ...
    net = build_ssd300_fpn75('test', size=300, num_classes=21)
